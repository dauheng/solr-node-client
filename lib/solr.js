...
/**
 * DH fork
 * This is a function to perform post query to solr.
 */
Client.prototype.post = function(query,json,callback){
   ...
   var params = {
      ...
      port : this.options.port,
      fullPath : fullPath,
      json : pickJSON(this.options.bigint).stringify(json),
      secure : this.options.secure,
      bigint : this.options.bigint,
      authorization : this.options.authorization,
      agent : this.options.agent
